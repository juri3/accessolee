	...
	<body>
		...
		<div class="row" align="left" style="margin-top:50px"; >
	        ...
	        <div class="col-sm-4" style="margin-right: 25px; margin-left:100px;">
	        	<div class="row">
					<div class="col-sm">
						<img src="img/bracelet2.jpg" id="pic"> 
					</div>
					<div class="col-sm">
			        <p>No.</p>
			        <p>Item.</p>
		...
		<div class="row" align="left" style="margin-top:100px"; >
			<div class="col-sm-4" style="margin-right: 25px; margin-left:100px;">
				<div class="row">
					<div class="col-sm">
						<img src="img/bracelet3.jpg" id="pic"> 
					</div>
					<div class="col-sm">
			        <p>No.</p>
			        <p>Item.</p>
	        ...
	        <div class="col-sm-4" style="margin-right: 25px; margin-left:100px;">
	        	<div class="row">
					<div class="col-sm">
						<img src="img/bracelet4.jpg" id="pic"> 
					</div>
					<div class="col-sm">
			        <p>No.</p>
			        <p>Item.</p>
		...
		<div class="row" align="left" style="margin-top:100px; margin-bottom:150px;"  >
			<div class="col-sm-4" style="margin-right: 25px; margin-left:100px;">
				<div class="row">
					<div class="col-sm">
						<img src="img/bracelet5.jpg" id="pic"> 
					</div>
					<div class="col-sm">
			        <p>No.</p>
			        <p>Item.</p>
	        ...
	        <div class="col-sm-4" style="margin-right: 25px; margin-left:100px; ">
	        	<div class="row">
					<div class="col-sm">
						<img src="img/bracelet6.jpg" id="pic"> 
					</div>
					<div class="col-sm">
			        <p>No.</p>
			        <p>Item.</p>
