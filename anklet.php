...
<html>
	...
	<body>
		...
		<p align="center"><a href="home.php"><img src="img/accsolee2.jpg"  style="margin-top: 50px; margin-bottom: 50px" ></a></p>	
		<?php	include("nav.php");   //nav 삽입 ?>	

		<h5 align="left" style="margin-left: 90px; margin-top: 50px;">●  Anklet</h5>

		<div class="row" align="left" style="margin-top:50px"; >
			<div class="col-sm-4" style="margin-right: 25px; margin-left:100px;">
				<div class="row">
					<div class="col-sm">
						<img src="img/anklet.jpg" id="pic"> 
					</div>
					<div class="col-sm">
			        <p>No.</p>
			        <p>Item.</p>
	        ...
	        <div class="col-sm-4" style="margin-right: 25px; margin-left:100px;">
	        	<div class="row">
					<div class="col-sm">
						<img src="img/anklet2.jpg" id="pic"> 
					</div>
					<div class="col-sm">
			        <p>No.</p>
			        <p>Item.</p>
		...
		<div class="row" align="left" style="margin-top:100px"; >
			<div class="col-sm-4" style="margin-right: 25px; margin-left:100px;">
				<div class="row">
					<div class="col-sm">
						<img src="img/anklet3.jpg" id="pic"> 
					</div>
					<div class="col-sm">
			        <p>No.</p>
			        <p>Item.</p>
	        ...
	        <div class="col-sm-4" style="margin-right: 25px; margin-left:100px;">
	        	<div class="row">
					<div class="col-sm">
						<img src="img/anklet4.jpg" id="pic"> 
					</div>
					<div class="col-sm">
			        <p>No.</p>
			        <p>Item.</p>
		...
		<div class="row" align="left" style="margin-top:100px; margin-bottom:150px;"  >
			<div class="col-sm-4" style="margin-right: 25px; margin-left:100px;">
				<div class="row">
					<div class="col-sm">
						<img src="img/anklet5.jpg" id="pic"> 
					</div>
					<div class="col-sm">
			        <p>No.</p>
			        <p>Item.</p>
	        ...
	        <div class="col-sm-4" style="margin-right: 25px; margin-left:100px; ">
	        	<div class="row">
					<div class="col-sm">
						<img src="img/anklet6.jpg" id="pic"> 
					</div>
					<div class="col-sm">
			        <p>No.</p>
			        <p>Item.</p>
